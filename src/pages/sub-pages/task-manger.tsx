      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="bg-blue-600 text-white">
          <CardContent className="pt-4 text-center">
            ...
            <p className="text-[10px] uppercase font-bold">Progress</p>
          </CardContent>
        </Card>
        <Card className="bg-emerald-600 text-white">
          <CardContent className="pt-4 text-center">
            <p className="text-3xl font-black">{points}</p>
            <p className="text-[10px] uppercase font-bold">Total XP</p>
          </CardContent>
        </Card>
        <Card className="bg-slate-800 text-white">
          <CardContent className="pt-4 text-center">
            <p className="text-3xl font-black">{efficiencyScore}</p>
            <p className="text-[10px] uppercase font-bold">Efficiency</p>
          </CardContent>
        </Card>
        <Button
          variant="destructive"
      ...
      <Card className="lg:col-span-1 bg-background">
        <CardHeader>
          <CardTitle className="text-sm flex items-center gap-2">
            <BarChart3 className="w-4 h-4" /> Priority Distribution
          </CardTitle>
        </CardHeader>
